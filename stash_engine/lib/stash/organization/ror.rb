  ...
  module Organization
    ...
    module Ror
      ...
      def find_by_ror_name(query)
        ...
        Rails.logger.error("Unable to connect to the ROR API for `find_by_ror_name`: #{e.message}")
      end
      ...
      def find_first_by_ror_name(ror_name)
        ...
        Rails.logger.error("Unable to connect to the ROR API for `find_first_by_ror_name`: #{e.message}")
      end
      ...
      def find_by_ror_id(ror_id)
        ...
        Rails.logger.error("Unable to connect to the ROR API for `find_by_ror_id`: #{e.message}")
      end
